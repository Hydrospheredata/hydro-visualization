...
from app.grpc_app import serve
...
from app.utils.conf import MONGO_URL, MONGO_PORT, MONGO_USER, MONGO_PASS, MONGO_AUTH_DB, DEBUG_ENV, \
    APP_PORT, HS_CLUSTER_ADDRESS, GRPC_PROXY_ADDRESS, EMBEDDING_FIELD, GRPC_PORT, URL_PREFIX, BUILDINFO
from app.utils.conf import app, hs_cluster, mongo_collection, params_validator, TaskStates
from app.utils import data_management
from app.utils.logs import disable_logging
from app.transformation_tasks.tasks import transform_task
...
def set_params(method: str):
    ...
    record['visualization_metrics']: List[str] = request_json.get(
